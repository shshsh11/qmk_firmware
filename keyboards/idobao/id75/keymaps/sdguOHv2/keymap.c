...
*/
 ...
 [_MAIN] = LAYOUT_ortho_5x15(
   KC_MINS,  KC_B,    KC_U,    KC_G,    KC_SPC,       KC_DOT,    KC_PSLS, KC_PAST,   KC_PMNS,    KC_6,     KC_7,    KC_8,    KC_9,    KC_0,      QK_BOOT,
   KC_TAB,   KC_I,    KC_N,    KC_T,    KC_H,         KC_D,      KC_KP_1, KC_KP_2,   KC_KP_3,    KC_F,     KC_G,  KC_C,    KC_R,    KC_L,      KC_SLSH,
   OSCTL,    KC_A,    KC_SPC,  KC_E,    OSL(_LOWER),  KC_COMM,  KC_KP_4, KC_KP_5,   KC_KP_6,    KC_D,     KC_H,    KC_T,    KC_N,    KC_S,      KC_ENT,
   KC_T,     KC_DOT,  KC_R,    KC_F,    KC_M,         OSL(_RAISE),  KC_KP_7, KC_KP_8,   KC_KP_9,    KC_B,     KC_M,    KC_W,    KC_V,    KC_Z,     KC_RSFT,
   _______,  KC_CAPS, KC_LGUI, KC_LALT, KC_BSPC,      KC_O,      KC_PDOT, KC_KP_0,   KC_PPLS,    KC_BSPC,  MO(3),   KC_RALT, KC_RGUI, QK_BOOT,   _______ 
  ),

 [_LOWER] = LAYOUT_ortho_5x15(
    KC_ESC,   KC_Q,   KC_B,    KC_QUOT,  KC_J,       KC_GRV,    _______, _______, _______, _______,  _______,  _______,  _______, _______, _______,
    KC_TAB,   KC_V,   OSSFT,   KC_W,     KC_P,       KC_UNDS,    _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______,
    _______,  KC_R,   KC_L,    KC_S,     _______,    KC_X,       _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______, 
    KC_D,     KC_SCLN,KC_C,    KC_Y,     KC_SLSH,    _______,        _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______, 
    _______, _______, _______, _______,  MO(_RAISE2),KC_ENT,    _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______ 
  ),  
  ...
  [_RAISE] = LAYOUT_ortho_5x15(
    ...
    KC_Z,     OSSFT,      KC_7,     KC_8,     KC_9,      _______, _______, _______, _______, _______,  KC_HOME, KC_PGDN,  KC_PGUP, KC_END,   _______, 
