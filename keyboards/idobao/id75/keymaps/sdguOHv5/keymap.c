...
*/
 ...
 [_MAIN] = LAYOUT_ortho_5x15(
   ...
   KC_B,     KC_F,    KC_I,    KC_V,        KC_N,     OSL(_RAISE),  KC_KP_7, KC_KP_8,   KC_KP_9,    KC_B,     KC_M,    KC_W,    KC_V,    KC_Z,     KC_RSFT,
   _______,  KC_CAPS, KC_LGUI, KC_LALT,     KC_BSPC,  KC_SPC,      KC_PDOT, KC_KP_0,   KC_PPLS,    KC_BSPC,  MO(3),   KC_RALT, KC_RGUI, QK_BOOT,   _______ 
  ),

 [_LOWER] = LAYOUT_ortho_5x15(
    KC_ESC,   KC_Z,   KC_Q,    KC_X,        KC_J,   KC_GRV,    _______, _______, _______, _______,  _______,  _______,  _______, _______, _______,
    KC_TAB,   KC_D,   KC_L,    KC_B,        KC_U,     KC_T,    _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______,
    _______,  KC_G,   KC_O,    OSL(_LOWER), KC_R,     KC_C,       _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______, 
    KC_COMM,  KC_D,   KC_N,    KC_SCLN,     KC_M,     KC_K,        _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______, 
    _______, _______, _______, KC_LALT,     MO(_RAISE2), KC_Y,    _______, _______, _______,  _______,    _______,  _______,  _______, _______, _______ 
  ),  
