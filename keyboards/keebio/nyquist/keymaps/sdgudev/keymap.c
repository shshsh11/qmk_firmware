...
[_RAISE] = LAYOUT( \
  ...
  KC_DEL,  KC_F1,   KC_VOLD,   KC_VOLU,   KC_MUTE,   KC_F5,   KC_F6,   KC_LEFT, KC_DOWN,  KC_RGHT, KC_RBRC, KC_BSLS, \
 ...
 * `-----------------------------------------------------------------------------------'
 */
<<<<<<< HEAD:keyboards/planck/keymaps/steno/keymap.c
...
>>>>>>> a98a25cf1a (adding my old nyquist keymap):keyboards/keebio/nyquist/keymaps/sdgudev/keymap.c
)
